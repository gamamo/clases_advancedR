...
- Por eso la importancia de visualizar rapidamente los posible problemas
...
-   Documentació [aqui](https://cran.r-project.org/web/packages/skimr/vignettes/skimr.html) y [aqui](https://docs.ropensci.org/skimr/articles/extending_skimr.html)
:::
:::
